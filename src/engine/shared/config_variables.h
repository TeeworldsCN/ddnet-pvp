...
MACRO_CONFIG_INT(SvOldLaser, sv_old_laser, 1, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether lasers can hit you if you shot them and that they pull you towards the bounce origin (0 for all new maps) or lasers can't hit you if you shot them, and they pull others towards the shooter")
...
MACRO_CONFIG_INT(SvShowOthersDefault, sv_show_others_default, 2, 0, 2, CFGFLAG_SERVER, "Whether players see others by default (2 for own team)")
